...
<template>
    <div class="imServer-wrapper">
        <main class="imServer-main">
            <im-record :class="{ record_show: recordShow }" class="item im-record" @selectedChat="selectedChat()"
                @toggleUserList=toggleUserList></im-record>
            <im-chat v-show="user_info.user_type != ''" ref="im_chat" class="item im-chat" @toggleUserList=toggleUserList>
            </im-chat>
            <div class="user_info">
                <div v-if="user_info.user_type == 'sdk-user'" class="sdk_info">
                    ...
                    <el-card class="box-card">
                        ...
                        <el-table :data="user_info.rolesList.data" height="300" style="width: 100%">
                            <el-table-column prop="gameName" label="游戏名称" width="180">
                            </el-table-column>
                            <el-table-column prop="createdAt" label="创建时间" width="180">
                            </el-table-column>
                            <el-table-column prop="roleLevel" label="角色等级">
                            </el-table-column>
                            <el-table-column prop="roleName" label="角色名">
                            </el-table-column>
                            <el-table-column prop="roleVip" label="角色VIP等级">
                            </el-table-column>
                            <el-table-column prop="serverName" label="服务器名称">
                            </el-table-column>
                            <el-table-column prop="union" label="工会">
                            </el-table-column>
                        </el-table>
                    </el-card>
                    <el-card class="box-card">
                        ...
                        <el-table :data="user_info.loginLogsList.data" height="300" style="width: 100%">
                            <el-table-column prop="gameName" label="游戏名称" width="180">
                            </el-table-column>
                            ...
                            <el-table-column prop="drivceBrand" label="设备品牌">
                            </el-table-column>
                            <el-table-column prop="drivceModel" label="设备型号">
                            </el-table-column>
                            <el-table-column prop="drivceSn" label="设备序列号">
                            </el-table-column>
                            <el-table-column prop="IDFA" label="IDFA">
                            </el-table-column>
                            <el-table-column prop="IDFV" label="IDFV">
                            </el-table-column>
